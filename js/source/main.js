...
$(document).ready(function () {
  ...
  if (!coursesAreSetUp) {
    ...
    for (var i = 0; i < courses.length; i++) {
      ...
      $(courses[i])
        .parent()
        .css({ height: height + "px", "min-height": minHeight + "px" });
      var semesters = $(courses[i])
        .children(".listWrapper")
      ...
      $(courses[i])
        ...
        .css({
          height: height + "px",
          width: semesters * width + "px",
          "min-height": minHeight + "px",
        });
      var courseListWrappers = $(courses[i])
        .children(".listWrapper")
        .children(".courseListWrapper");
      for (var a = 0; a < courseListWrappers.length; a++) {
        $(courseListWrappers[a]).css({
          width: width + "px",
          height: height + "px",
          "min-height": minHeight + "px",
        });
  ...
  $(".showCourses").click(function () {
    ...
    if (text == "Show Courses") {
      ...
      var $newCourses = $(this)
        ...
        .children(".courses");
      $newCourses.children(".coursesUpper").children("p").text("Courses");
      ...
      var $courses = $(this)
        ...
        .siblings(".courseWrapper")
        .children(".courses");
      $courses.children(".coursesUpper").children("p").text("Courses");
  ...
  $(".courseRight").click(function () {
    ...
    $(this)
      .parent()
      .siblings(".listWrapper")
      .css({ transform: "translateX(" + (semester - 1) * width * -1 + "px)" });
    $(this)
      .siblings("p")
  ...
  function parallaxScroll() {
    ...
    $("#mountainHolder2").css(
      "transform",
      "translateY(" + Math.round(scrolled * 0.25) + "px)"
    );
    $("#mountainHolder").css(
      "transform",
      "translateY(" + Math.round(scrolled * 0.5) + "px)"
    );
  }
...
function whatBackground(scrolledY) {
  ...
  var slidesInProject =
    $(".projects").offset().top + $(".projects").height() - 100;
